...
export async function DesignHero() {
  const banners = await getBanners("design-page-hero").catch(() => null);
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-brand-dark">
      <BannerCarousel slug="design-page-hero" imgClassName="object-cover opacity-60" initialBanners={banners ?? undefined} />
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 w-full pt-32 pb-20 text-center">
        ...
        <h1 className="sr-only">Architectural Design Services</h1>
        <h1
