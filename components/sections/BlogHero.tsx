...
export async function BlogHero() {
  const banners = await getBanners("blog-page-hero").catch(() => null);
  return (
    <section className="relative min-h-[55vh] flex items-center overflow-hidden bg-brand-dark">
      <BannerCarousel slug="blog-page-hero" imgClassName="object-cover opacity-60" initialBanners={banners ?? undefined} />
