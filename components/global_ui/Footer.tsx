...
function FooterColHeader({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2.5 mb-5">
      ...
      <h3 className="text-[10.5px] font-bold uppercase tracking-[0.2em] text-white/50">
        {children}
      </h3>
    </div>
  );
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            ...
            <div className="max-w-[520px]">
              ...
              >
                ...
                <span className="text-white/50 font-semibold">Let&apos;s build something great.</span>
              </p>
            </div>
              ...
              <ul className="space-y-3.5">
                {c.phone && (
                  <li className="flex items-start gap-2.5">
                    ...
                    <a href={`tel:${c.phone}`} className="text-[13px] text-white/50 hover:text-white transition-colors">{c.phone}</a>
                  </li>
                )}
                {c.phone && (
                  <li className="flex items-start gap-2.5">
                    ...
                    <a href={waLink} target="_blank" rel="noopener noreferrer" className="text-[13px] text-white/50 hover:text-white transition-colors">WhatsApp</a>
                  </li>
                )}
                {c.email && (
                  <li className="flex items-start gap-2.5">
                    <Mail className="size-3.5 text-brand-secondary shrink-0 mt-[3px]" />
                    <a href={`mailto:${c.email}`} className="text-[13px] text-white/50 hover:text-white transition-colors break-all">{c.email}</a>
                  </li>
                )}
              </ul>
            </div>
