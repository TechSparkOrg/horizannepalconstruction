        ...
        <div className="flex flex-wrap items-center gap-5 text-sm text-[#5a6e8a]">
          {author && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-[#0f2557] text-[13px] leading-tight">
                  {author}
                </p>
                {authorRole && (
                  <p className="text-[11px] leading-tight text-[#5a6e8a] mt-0.5">
                    {authorRole}
                  </p>
                )}
              </div>
          ...
          {author && date && (
            <span className="w-px h-4 bg-[#e8edf5] shrink-0" />
          )}
