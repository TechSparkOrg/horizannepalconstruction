...
const ServicesSection = dynamic(() => import("@/components/global_ui/ServicesSection").then((m) => ({ default: m.ServicesSection })), { ssr: false })
const AboutGallery = dynamic(() => import("@/components/global_ui/image-grid").then((m) => ({ default: m.ImageGrid })), { ssr: false })
const TeamSection = dynamic(() => import("@/components/global_ui/TeamSection").then((m) => ({ default: m.TeamSection })), { ssr: false })
const TestimonialsSection = dynamic(() => import("@/components/global_ui/TestimonialsSection").then((m) => ({ default: m.TestimonialsSection })), { ssr: false })
...
export function AboutClient({ page, team }: { page: Page | null; team: TeamMember[] }) {
  return (
    <>
      <AboutTabs />
      <ServicesSection />
