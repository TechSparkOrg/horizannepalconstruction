...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Construction Materials | Horizan Nepal",
    description:
      "Explore high-quality construction materials from trusted partners across Nepal. Find pricing, specifications, and supplier details for your project.",
    openGraph: {
      title: "Construction Materials | Horizan Nepal",
      description:
        "Explore high-quality construction materials from trusted partners across Nepal.",
    },
  };
}

export default async function MaterialPage() {
  const banners = await getBanners("material-page-hero").catch(() => null);
  const bannerImages: MediaItem[] = (banners ?? []).map((b) => ({
    id: b.id,
    url: b.url,
    alt: b.alt || b.title || "Construction Materials",
    title: b.title,
  }));

  return (
    <>
      <h1 className="sr-only">Construction Materials — Horizan Nepal</h1>
