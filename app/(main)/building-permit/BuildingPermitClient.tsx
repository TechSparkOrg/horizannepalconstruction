    ...
    <section className={`py-20 sm:py-28 ${className || ""}`}>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          <div className="mx-auto h-4 w-20 rounded-full bg-light-gray/50 animate-pulse" />
          <div className="mx-auto mt-3 h-8 w-72 rounded-lg bg-light-gray/50 animate-pulse" />
          <div className="mx-auto mt-3 h-4 w-56 rounded bg-light-gray/50 animate-pulse" />
        </div>
      </div>
    </section>
  );
  ...
  return (
    <>
      ...
      {!buildingPermitConfig ? (
        <>
          <SkeletonSection className="bg-white" />
          <SkeletonSection className="bg-off-white" />
          <SkeletonSection className="bg-white" />
          <SkeletonSection className="bg-off-white" />
        </>
      ) : (
