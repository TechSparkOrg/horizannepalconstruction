...
const SvgIcon = ({ children, viewBox = "0 0 24 24", className }: { children: React.ReactNode; viewBox?: string; className?: string }) => (
...
export const getSocialIcon = (platform: string) =>
  PLATFORM_ICONS[platform.toLowerCase()] ?? FALLBACK;
